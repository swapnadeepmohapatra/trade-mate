...
function StockInfo({ symbol }: StockInfoProps) {
  ...
  const [selectedAttributes, setSelectedAttributes] = useState<{
    ...
    ratios: ["Debtor Days", "ROCE %", "Working Capital Days"],
  });
                ...
                stockInfo?.data?.[chart]
                  ? {
                      ...
                      rows: stockInfo.data?.[chart].rows.filter((row) =>
                        selectedAttributes?.[chart].includes(row.key)
                      ),
                    }
                  : {
                      headers: [],
                    ...
                    onChange={() => {
                      setSelectedAttributes({
                        ...
                        [selectedChart]: selectedAttributes[
                          ...
                          : [...selectedAttributes[selectedChart], row.key],
                      });
                    }}
                  >
                    {row.key}
